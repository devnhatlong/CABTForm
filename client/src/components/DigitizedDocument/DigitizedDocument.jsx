...
export const DigitizedDocument = () => {
                ...
                <Loading isLoading = {isLoadingUpdate}>
                    ...
                    >
                        <Form.Item
                            ...
                            rules={[{ required: true, message: 'Vui lòng nhập năm!' }]}
                        >
                            <InputComponent type="number" name="year" value={stateDigitizedDocumentDetail.year} onChange={(e) => handleOnChangeDetail('year', e.target.value)} min="0" onKeyDown={handleKeyPress} disabled/>
                        </Form.Item>
                        <Form.Item
                            label="Tổng số hồ sơ"
                            name="total_documents_count"
